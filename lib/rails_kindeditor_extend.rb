require 'rails_kindeditor_extend/engine'
require 'rails_kindeditor_extend/helper'
require 'rails_kindeditor_extend/active_record'
require 'carrierwave'
require 'mini_magick'
...
module RailsKindeditorExtend
  ...
  def self.base_path
    self.asset_url_prefix ? "#{self.asset_url_prefix}/kindeditor_extend/" : '/assets/kindeditor_extend/'
  end
